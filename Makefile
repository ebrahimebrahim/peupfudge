...
$(OUTPUT): $(TYPST_SOURCES) ndf_table.json ndf_plot.pdf $(SVG_ASSETS) $(ILLUSTRATIONS) $(FONTS) python/make_version.py $(PYTHON_ENV) FORCE
...
clean:
	rm -f $(OUTPUT) ndf_table.json ndf_plot.pdf $(VERSION_FILE)
