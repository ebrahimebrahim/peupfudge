...
#example[
  ...
  In order to determine the resulting levels and the XP progress towards the next level, @sec-abilities is applied:
  ...
  - Rested (+1 to A for actions involving Muscle or Perception)
  - Neutral (no effect)
  - Tired (-1 to A for actions involving Muscle or Perception)
  - Exhausted (-2 to A for actions involving Muscle or Perception)
