...
When creating their world, the GM should choose a \emdex{baseline target size}
...
Actually, the GM can include these protection modifiers\index{protection modifier}
on the body diagram\index{body diagram}
...
\paragraph{Healing} Wounds are treated like any other health condition, so healing\index{healing flowchart}
