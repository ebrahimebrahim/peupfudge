...
def write_tex(tree_file, vert_spacing, horiz_spacing, dn=None):
  ...
  f = open(os.path.join(trees_dir,tree_file+((".d"+str(dn)) if dn else "")+".tex"),'w')
  f.write("% THIS FILE WAS AUTOMATICALLY GENERATED BY "+scriptname+"\n\n")
  f.write(tree.tex(vert_spacing = vert_spacing, horiz_spacing = horiz_spacing, dn=dn))
  f.close()

def main():
  write_tex("example.tree", 0.85, [3,3.5,3])
  write_tex("example.tree", 0.85, [3,3.5,3],dn=20)
