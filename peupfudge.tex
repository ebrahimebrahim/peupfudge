...
When creating their world, the GM should choose a baseline target size with respect to which all target sizes are compared.
The choice of baseline target calibrates the entire damage system to target size.
A good baseline target is one that, all other things being equal, would be injured a bit from a good punch.
...
%intro, target body part, hp of body parts and wound of 'degree' x

%need to convert bullets of impact and protection section into pars
%develop par on size. up there, that is. include protection table.
...
%damage dealt is according to following table. record new hp
