...
Here are some suggestions for factors to consider:
\vspace{-1em}\begin{itemize}
\item Abilities. A stronger character deals a deadlier blow with a melee weapon.
...
\item Size. The same blow imparts greater destruction to smaller targets. 
\end{itemize}
