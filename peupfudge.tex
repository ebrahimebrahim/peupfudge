...
If no relevant ability could be identified, assign a value of 5 to $\ODFA$ or $\DDFA$. 
The attacker's damage modifier $\ODFM$ consists of other factors that contribute to the ability of the attack to do damage 
(e.g. weapon being used), 
and the defender's damage modifier $\DDFM$ consists of other factors that contribute to the ability of the defender
to absorb damage (e.g. armor being used).
Putting it together,
