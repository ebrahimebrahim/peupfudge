...
This introduces a \emph{targetting penalty} that decreases $M$, based on the difficulty of hitting that body part.
...
\notes{I randomly chose those numbers. Let's discuss and find actually suitable numbers there.}
