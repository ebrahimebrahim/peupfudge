...
\end{center}
Now when a player trains their \emph{climbing} skill by spending the needed xp,
...
A reasonable root ability, if it is desired, would be akin to the notion of a ``character level'' common to role playing games.
...
\notes{explain what powers are and how they sit in the tree (just pretend they don't exist if off... wait does that even make sense)}
...
exactly what it is about their game world they need to specify. ideally this should be short, and in list format"}
