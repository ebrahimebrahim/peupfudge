...
In short: attacks are resolved as opposed actions to determine whether they succeeded,
and successful attacks are followed by further rolling for the severity of the outcome.
