...
Here's how it works:
Let $A$ and $B$ are abilities such that $A$ governs $B$ with $B$ bearing weight $w$ (so $A \xrightarrow{w} B$ in the ability tree).
