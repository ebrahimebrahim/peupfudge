...
for the attack. It is defined to be the difference between the \emph{damage factors} $\ODF$ and $\DDF$ of the attacker and the defender, respectively:
$$ \NDF = \ODF - \DDF. $$
...
The ability that goes into $\ODFA$ should be one\footnote{The GM should decide w} that plays a role in determining how
powerful the attack is (e.g. strength for an axe swing).
The abilit
The damage modifier represents the ability of the attack to do damage due to the
