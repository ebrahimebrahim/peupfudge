...
(e.g. deaf, blessed).
\item \emph{Bars} are other statuses that need Denis tracking (e.g. mana, hunger, reputation).
...
The setting or focus of a campaign might call for the Denis tracking of specific
