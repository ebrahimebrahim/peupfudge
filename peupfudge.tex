...
The modifiers $M$ and $M'$ are comprised of situational modifiers and stance modifiers, which will be explained below.
First we define a quantity that will help us describe the damage resulting from hits and grazes.
...
\paragraph{Grazing}
A graze results in $$ \NDF + 1\text{dF} $$
damage applied to the defender.

\notes{wait... graze severity comes from a different table than hit severity... that's peup...}
